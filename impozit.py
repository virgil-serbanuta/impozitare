...
SALARIU_PENTRU_CONTRIBUTIE_VOLUNTARA_PENSIE = 9000
...
PRAG_CONTRIBUTIE_6_SALARII = SALARIU_MINIM_BRUT * 6 # $E$6
PRAG_CONTRIBUTIE_12_SALARII = SALARIU_MINIM_BRUT * 12 # $E$7
PRAG_CONTRIBUTIE_24_SALARII = SALARIU_MINIM_BRUT * 24 # $E$8
PRAG_CONTRIBUTIE_60_SALARII = SALARIU_MINIM_BRUT * 60 # $E$10
...
IMPOZIT_DIVIDENDE = 0.1 # $B$8
PRAG_IMPOZIT_MICRO = 300000 # $B$9
CAS_CASS_SALARIU_MINIM = (SALARIU_MINIM_BRUT - 200) * (CONTRIBUTIE_CAS+CONTRIBUTIE_CASS)
CONTRIBUTIE_ASIGURATIORIE_MUNCA_SALARIU_MINIM = (SALARIU_MINIM_BRUT - 200) * 0.0225 # $B$21
CONTRIBUTIE_ASIGURATIORIE_MUNCA_SALARIU_MINIM_ANUAL = CONTRIBUTIE_ASIGURATIORIE_MUNCA_SALARIU_MINIM * 12 # $C$21
TAXE_SALARIU_MINIM = (
  (
      CAS_CASS_SALARIU_MINIM +
      ((SALARIU_MINIM_BRUT - 200) - CAS_CASS_SALARIU_MINIM - 600) * IMPOZIT_VENIT +
      CONTRIBUTIE_ASIGURATIORIE_MUNCA_SALARIU_MINIM
  ) * 12
) # $B$20
